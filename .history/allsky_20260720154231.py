...
# Kompresja dynamiki jasności Drogi Mlecznej:
# rozjaśnienie słabych struktur i zbicie najjaśniejszych obszarów,
# aby centrum galaktyki nie było przepalone
hist = hist ** 0.55

# ograniczenie dominacji najjaśniejszych pikseli
hist = hist / (hist + 0.35)
