...
INPUT_FILE = "gaia_6x0m_allsky.fits"
...
# Oś czasu zgodna z rzeczywistym MJD zdarzeń Gaia
# Najdłuższe zdarzenia będą miały pełny czas widoczności,
# krótsze będą proporcjonalnie krótsze.

frames = 750
animation_duration = 30.0

# zakres obserwacji rozciągnięty o czas trwania zdarzeń
anim_start = np.nanmin(ml_tmax - 3 * ml_te)
anim_end = np.nanmax(ml_tmax + 3 * ml_te)
