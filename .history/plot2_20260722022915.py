...
def draw_gaussians(canvas, px_arr, py_arr, sigma_arr, alpha_arr, color):
    ...
    for cx, cy, sig, alph in zip(px_arr, py_arr, sigma_arr, alpha_arr):
        ...
        # Spłaszczenie szczytu Gaussa:
        # wartości powyżej flat_level tworzą większy jasny obszar o intensywności 1
        flat_level = 0.5
        gauss = np.where(
            gauss > flat_level,
            1.0,
