...
def _init_worker(animation_dpi):
    ...
    outer = ax.scatter([], [], s=[], c=[], marker="o", edgecolors="none", zorder=100, transform=ax.transData)
    inner = ax.scatter([], [], s=[], c=[], marker="o", edgecolors="none", zorder=101, transform=ax.transData)
    core = ax.scatter([], [], s=[], c=[], marker="o", edgecolors="none", zorder=102, transform=ax.transData)
