...
def _init_worker(animation_dpi):
    ...
    outer = ax.scatter([], [], s=[], c=[], marker="o", edgecolors="none", zorder=100)
    inner = ax.scatter([], [], s=[], c=[], marker="o", edgecolors="none", zorder=101)
    core = ax.scatter([], [], s=[], c=[], marker="o", edgecolors="none", zorder=102)
