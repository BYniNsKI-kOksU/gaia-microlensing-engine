...
# czas symulacji w MJD
anim_start = np.nanmin(ml_tmax - 5 * ml_te)
anim_end = np.nanmax(ml_tmax + 5 * ml_te)

frames = 300
current_times = np.linspace(anim_start, anim_end, frames)
