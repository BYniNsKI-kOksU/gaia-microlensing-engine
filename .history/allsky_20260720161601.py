...
# Silniejsza kompresja dynamiki jasności Drogi Mlecznej:
# ograniczenie dominacji centrum i zachowanie słabszych struktur
hist = hist ** 0.75

# mocniejsze ściśnięcie najwyższych wartości jasności
hist = hist / (hist + 0.8)
...
bins_b = 8640
# 16k 
fig = plt.figure(figsize=(32, 181), dpi=300, facecolor="black")
