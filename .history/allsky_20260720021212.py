...
# Skala logarytmiczna gęstości + rozjaśnienie słabych struktur
hist = np.log10(hist + 1)

# rozciągnięcie kontrastu: uwidacznia zewnętrzne ramiona i halo
hist = hist / np.percentile(hist, 99.5)
hist = np.clip(hist, 0, 1)

# gamma < 1 rozjaśnia słabe obszary
hist = hist ** 0.55
