...
if __name__ == "__main__":
    main()
# -----------------------------
# GAIA RANDOM_INDEX QUERY RANGE (to be used if needed)
# -----------------------------
#
# Example usage for Gaia query:
# WHERE random_index >= 1376899410 AND random_index < 1413133605
#
# Progress counter for this range:
# print("Przedział 39/50")
